...
COPY DasiwaMinimaxH3WorkflowsT2VA_cMMH3V12.json /ComfyUI/user/default/workflows/DasiwaMinimaxH3WorkflowsT2VA_cMMH3V12.json
COPY lonecatsSimpleWorkflowsMinimaxH3Krea2_simpleMinimaxH3.json /ComfyUI/user/default/workflows/lonecatsSimpleWorkflowsMinimaxH3Krea2_simpleMinimaxH3.json
COPY MiniMaxH3-fl2va-ref2va.json /ComfyUI/user/default/workflows/MiniMaxH3-fl2va-ref2va.json
